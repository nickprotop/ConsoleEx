...
class Program
{
    ...
    static void CreateMainWindow(ConsoleWindowSystem windowSystem)
    {
        ...
        var menu = Controls
            ...
            .AddItem(
                "File",
                m =>
                    m.AddItem("New", "Ctrl+N", () => LogAction("New file created"))
                        ...
                        .AddItem(
                            ...
                            sub =>
                                sub.AddItem(
                                        "Document1.txt",
                                        () => LogAction("Opened Document1.txt")
                                    )
                                    .AddItem(
                                        "Document2.txt",
                                        () => LogAction("Opened Document2.txt")
                                    )
                                    .AddItem(
                                        "Document3.txt",
                                        () => LogAction("Opened Document3.txt")
                                    )
                                    .AddSeparator()
                                    .AddItem(
                                        "Clear Recent Files",
                                        () => LogAction("Recent files cleared")
                                    )
                        )
                        .AddSeparator()
            ...
            .AddItem(
                "Edit",
                m =>
                    m.AddItem("Undo", "Ctrl+Z", () => LogAction("Undo last action"))
            ...
            .AddItem(
                ...
                m =>
                    m.AddItem(
                            "Zoom",
                            sub =>
                                sub.AddItem("Zoom In", "Ctrl++", () => LogAction("Zoomed in"))
                                    ...
                                    .AddItem(
                                        "Actual Size",
                                        () => LogAction("Zoom set to actual size")
                                    )
                        )
                        .AddSeparator()
                    ...
                    m.AddItem(
                            ...
                            sub =>
                                sub.AddItem(
                                        "Increase Font Size",
                                        "Ctrl+>",
                                        () => LogAction("Font size increased")
                                    )
                                    .AddItem(
                                        "Decrease Font Size",
                                        "Ctrl+<",
                                        () => LogAction("Font size decreased")
                                    )
                                    .AddSeparator()
                                    .AddItem(
                                        "Font Family",
                                        subsub =>
                                            subsub
                                                .AddItem(
                                                    "Consolas",
                                                    () => LogAction("Font changed to Consolas")
                                                )
                                                .AddItem(
                                                    "Courier New",
                                                    () => LogAction("Font changed to Courier New")
                                                )
                                                .AddItem(
                                                    "Monaco",
                                                    () => LogAction("Font changed to Monaco")
                                                )
                                                .AddItem(
                                                    "Source Code Pro",
                                                    () =>
                                                        LogAction("Font changed to Source Code Pro")
                                                )
                                    )
                        )
                        .AddSeparator()
                        ...
                        .AddItem(
                            "Underline",
                            "Ctrl+U",
                            () => LogAction("Underline formatting applied")
                        )
            )
            .AddItem(
                "Tools",
                m =>
                    m.AddItem("Options", () => LogAction("Options dialog opened"))
                        ...
                        .AddItem(
                            "Command Palette",
                            "Ctrl+Shift+P",
                            () => LogAction("Command palette opened")
                        )
            )
            .AddItem(
                "Help",
                m =>
                    m.AddItem("Documentation", "F1", () => LogAction("Documentation opened"))
                        .AddItem(
                            "Keyboard Shortcuts",
                            "Ctrl+K Ctrl+S",
                            () => LogAction("Keyboard shortcuts opened")
                        )
                        .AddSeparator()
        ...
        var instructions = Controls
            ...
            .AddLine(
                "• Full keyboard navigation (Arrow keys, Enter, Escape, Home/End, Letter keys)"
            )
    ...
    static void LogAction(string action)
    {
        ...
        {
            _statusControl.SetContent(
                new List<string> { $"[green]Action #{_actionCounter}:[/] {action}" }
            );
        }
    }
}
