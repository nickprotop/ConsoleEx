...
public class BuiltInThemeGoldenTests
{
	private static readonly Dictionary<string, string> Golden = new()
	{
		...
		{ "ModernGray.DangerColor", "Color(128, 0, 0)" },
		{ "ModernGray.InfoColor", "Color(95, 135, 175)" },
		{ "ModernGray.PrimaryColor", "Color(0, 255, 255)" },
		{ "ModernGray.SecondaryColor", "Color(95, 135, 175)" },
		{ "ModernGray.SuccessColor", "Color(0, 128, 0)" },
		{ "ModernGray.TertiaryColor", "Color(135, 95, 255)" },
		{ "ModernGray.WarningColor", "Color(215, 135, 0)" },
