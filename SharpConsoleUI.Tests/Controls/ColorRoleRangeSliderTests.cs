...
public class ColorRoleRangeSliderTests
{
	...
	{
		var s = new RangeSliderControl { ColorRole = ColorRole.Danger };
		var plain = new RangeSliderControl();
	...
	{
		var s = new RangeSliderControl { ColorRole = ColorRole.Danger, FilledTrackColor = Color.Black };
