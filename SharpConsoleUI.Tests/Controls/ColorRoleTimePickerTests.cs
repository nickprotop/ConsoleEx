...
public class ColorRoleTimePickerTests
{
	[Fact]
	...
	{
		var t = new TimePickerControl { ColorRole = ColorRole.Danger };
		var plain = new TimePickerControl();
	...
	{
		var t = new TimePickerControl { ColorRole = ColorRole.Danger, ForegroundColor = Color.Black };
