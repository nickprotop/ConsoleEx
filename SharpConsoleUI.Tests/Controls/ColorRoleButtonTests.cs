...
public class ColorRoleButtonTests
{
	[Fact]
	...
	{
		var b = new ButtonControl { ColorRole = ColorRole.Danger };
	...
	{
		var b = new ButtonControl { ColorRole = ColorRole.Danger, ForegroundColor = Color.Black };
	...
	public void Outline_SwapsTextAndBackground()
	{
		...
		var outline = ColorRoleResolver.Resolve(ColorRole.Success, theme, outline: true);
		var filled = ColorRoleResolver.Resolve(ColorRole.Success, theme, outline: false);
