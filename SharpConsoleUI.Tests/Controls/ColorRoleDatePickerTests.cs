...
public class ColorRoleDatePickerTests
{
	[Fact]
	...
	{
		var d = new DatePickerControl { ColorRole = ColorRole.Danger };
		var plain = new DatePickerControl();
	...
	{
		var d = new DatePickerControl { ColorRole = ColorRole.Danger, ForegroundColor = Color.Black };
