...
public class ColorRoleSliderTests
{
	...
	{
		var s = new SliderControl { ColorRole = ColorRole.Danger };
		var plain = new SliderControl();
	...
	{
		var s = new SliderControl { ColorRole = ColorRole.Danger, FilledTrackColor = Color.Black };
