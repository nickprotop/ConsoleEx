...
namespace SharpConsoleUI.Configuration
{
	...
	public static class ControlDefaults
	{
		...
		/// <summary>
		/// Default maximum number of visible items in the command palette (default: 12).
		/// </summary>
		public const int CommandPaletteDefaultMaxVisibleItems = 12;

		/// <summary>
		/// Default width for the command palette in characters (default: 60).
		/// </summary>
		public const int CommandPaletteDefaultWidth = 60;

		/// <summary>
		/// Height of the search bar area in the command palette (default: 3).
		/// </summary>
		public const int CommandPaletteSearchBarHeight = 3;

		/// <summary>
		/// Height of a single item row in the command palette (default: 1).
		/// </summary>
		public const int CommandPaletteItemHeight = 1;

		/// <summary>
		/// Default placeholder text for the command palette search bar.
		/// </summary>
		public const string CommandPaletteDefaultPlaceholder = "Type to search...";

		/// <summary>
		/// Fuzzy match score bonus for consecutive character matches (default: 5).
		/// </summary>
		public const int CommandPaletteFuzzyConsecutiveBonus = 5;

		/// <summary>
		/// Fuzzy match score bonus for matches at word boundaries (default: 10).
		/// </summary>
		public const int CommandPaletteFuzzyWordBoundaryBonus = 10;

		/// <summary>
		/// Fuzzy match score bonus for matches at camelCase boundaries (default: 8).
		/// </summary>
		public const int CommandPaletteFuzzyCamelCaseBonus = 8;

		/// <summary>
		/// Fuzzy match score bonus for matching the first character (default: 15).
		/// </summary>
		public const int CommandPaletteFuzzyFirstCharBonus = 15;

		/// <summary>
		/// Fuzzy match score bonus for an exact prefix match (default: 20).
		/// </summary>
		public const int CommandPaletteFuzzyPrefixBonus = 20;

		/// <summary>
		/// Fuzzy match score penalty per gap character between matches (default: 1).
		/// </summary>
		public const int CommandPaletteFuzzyGapPenalty = 1;
	}
}
