...
namespace SharpConsoleUI.Themes
{
	...
	/// resolved to a coordinated colour set by <c>ColorRoleResolver</c>.
	/// </summary>
	...
	/// <summary>
	/// A coordinated set of colours derived from a single <see cref="ColorRole"/>: the foreground
	...
	/// </summary>
	public readonly record struct ColorRoleSet(Color Text, Color Background, Color TextOnBackground, Color Border);
}
