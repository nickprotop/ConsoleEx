...
namespace SharpConsoleUI.Themes
{
	...
	public class ClassicTheme : ITheme
	{
		...
		/// <inheritdoc />
		public virtual string Name => "Classic";

		/// <inheritdoc />
		public virtual string Description => "Classic Windows-style theme with bright blue and green accents";
		...
		/// </summary>
		public Color WindowBackgroundColor { get; set; } = Color.Navy;
		...
		/// </summary>
		public Color ProgressBarUnfilledColor { get; set; } = Color.Grey35;
		...
		/// </summary>
		public Color TableSelectionBackgroundColor { get; set; } = Color.Blue;
		...
		/// </summary>
		public Color TableHoverBackgroundColor { get; set; } = Color.DarkBlue;

		/// <summary>
		/// Gets or sets the foreground color for hovered rows in the table.
		/// </summary>
		public Color TableHoverForegroundColor { get; set; } = Color.White;

		/// <summary>
		/// Gets or sets the background color for selected rows in the table when unfocused.
		/// </summary>
		public Color TableUnfocusedSelectionBackgroundColor { get; set; } = Color.Navy;

		/// <summary>
		/// Gets or sets the foreground color for selected rows in the table when unfocused.
		/// </summary>
		public Color TableUnfocusedSelectionForegroundColor { get; set; } = Color.Silver;
		...
		public Color CollapsibleHeaderFocusedForegroundColor { get; set; } = Color.Green;

		/// <summary>Gets or sets the collapsible-panel header background color when focused.</summary>
		public Color CollapsibleHeaderFocusedBackgroundColor { get; set; } = Color.Navy;

		/// <summary>
		/// Gets or sets the background color for the active (selected) tab header.
		/// </summary>
		public Color TabHeaderActiveBackgroundColor { get; set; } = Color.Blue;

		/// <summary>
		/// Gets or sets the foreground color for the active (selected) tab header.
		/// </summary>
		public Color TabHeaderActiveForegroundColor { get; set; } = Color.White;

		/// <summary>
		/// Gets or sets the background color for inactive tab headers.
		/// </summary>
		public Color TabHeaderBackgroundColor { get; set; } = Color.Navy;

		/// <summary>
		/// Gets or sets the foreground color for inactive tab headers.
		/// </summary>
		public Color TabHeaderForegroundColor { get; set; } = Color.Silver;

		/// <summary>
		/// Gets or sets the foreground color for disabled tab headers.
		/// </summary>
		public Color TabHeaderDisabledForegroundColor { get; set; } = Color.Grey;

		/// <summary>
		/// Gets or sets the background color for disabled tab headers.
		/// </summary>
		public Color TabHeaderDisabledBackgroundColor { get; set; } = Color.Navy;
		...
		public Color TabHeaderFocusedBackgroundColor { get; set; } = Color.Navy;

		/// <summary>Inactive tab foreground when the header has keyboard focus.</summary>
		public Color TabHeaderFocusedForegroundColor { get; set; } = Color.Silver;
		...
		/// <inheritdoc/>
		public Color? StatusBarBackgroundColor { get; set; } = null;
		/// <inheritdoc/>
		public Color? StatusBarForegroundColor { get; set; } = null;
		/// <inheritdoc/>
		public Color? StatusBarShortcutForegroundColor { get; set; } = null;

		/// <inheritdoc/>
		public Color? SliderTrackColor { get; set; } = Color.Grey35;
		/// <inheritdoc/>
		public Color? SliderFilledTrackColor { get; set; } = Color.Cyan1;
		/// <inheritdoc/>
		public Color? SliderThumbColor { get; set; } = Color.White;
		/// <inheritdoc/>
