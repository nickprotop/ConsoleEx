...
namespace SharpConsoleUI.Video
{
	...
	public interface IVideoFrameSink : IDisposable
	{
		...
		/// </summary>
		/// <param name="rgb24">Row-major RGB24 pixel data for the decoded frame (not retained after the call).</param>
		/// <param name="pixelWidth">Source frame width in pixels.</param>
		/// <param name="pixelHeight">Source frame height in pixels.</param>
		...
		/// <param name="windowBackground">Background color to composite transparent or letterboxed regions against.</param>
