...
namespace SharpConsoleUI.Controls
{
	public partial class GridControl
	{
		...
		/// <returns>This grid, to allow fluent chaining.</returns>
		public GridControl RemoveColumnSplitterAfter(int afterIndex) { _splitters.RemoveAll(s => s.Matches(GridSplitterOrientation.Column, afterIndex)); Invalidate(Invalidation.Relayout); return this; }

		/// <summary>Removes the row splitter after <paramref name="afterIndex"/>, if present.</summary>
		/// <returns>This grid, to allow fluent chaining.</returns>
		public GridControl RemoveRowSplitterAfter(int afterIndex) { _splitters.RemoveAll(s => s.Matches(GridSplitterOrientation.Row, afterIndex)); Invalidate(Invalidation.Relayout); return this; }

		/// <summary>Removes every declared splitter from this grid.</summary>
		public void ClearSplitters() { _splitters.Clear(); Invalidate(Invalidation.Relayout); }
		...
		public Color? SplitterColor { get => _splitterColor; set { _splitterColor = value; Invalidate(Invalidation.Repaint); } }

		/// <summary>Background highlight when a splitter is focused or hovered. Null uses the theme button-focused background.</summary>
		public Color? SplitterFocusedBackground { get => _splitterFocusedBackground; set { _splitterFocusedBackground = value; Invalidate(Invalidation.Repaint); } }

		/// <summary>Glyph colour when a splitter is focused or hovered. Null uses the theme button-focused foreground.</summary>
		public Color? SplitterFocusedForeground { get => _splitterFocusedForeground; set { _splitterFocusedForeground = value; Invalidate(Invalidation.Repaint); } }

		/// <summary>Background highlight while a splitter is being dragged. Null uses the theme button-focused background.</summary>
		public Color? SplitterDraggingBackground { get => _splitterDraggingBackground; set { _splitterDraggingBackground = value; Invalidate(Invalidation.Repaint); } }

		/// <summary>Glyph colour while a splitter is being dragged. Null uses the theme button-focused foreground.</summary>
		public Color? SplitterDraggingForeground { get => _splitterDraggingForeground; set { _splitterDraggingForeground = value; Invalidate(Invalidation.Repaint); } }
