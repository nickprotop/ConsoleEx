...
/// <summary>Syntax highlighter for Dockerfiles.</summary>
/// <remarks>
...
/// </remarks>
[Obsolete("Regex highlighting is superseded by the TextMate engine. Use SyntaxHighlighters.For(\"dockerfile\") instead.")]
public class DockerfileSyntaxHighlighter : ISyntaxHighlighter
{
	private readonly ISyntaxHighlighter? _inner = TextMateHighlighting.For("dockerfile");
