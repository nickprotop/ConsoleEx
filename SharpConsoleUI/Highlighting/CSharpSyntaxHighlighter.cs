...
/// <summary>Syntax highlighter for C#.</summary>
/// <remarks>
...
/// </remarks>
[Obsolete("Regex highlighting is superseded by the TextMate engine. Use SyntaxHighlighters.For(\"csharp\") instead.")]
public class CSharpSyntaxHighlighter : ISyntaxHighlighter
{
	private readonly ISyntaxHighlighter? _inner = TextMateHighlighting.For("csharp");
