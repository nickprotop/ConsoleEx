...
/// <summary>Syntax highlighter for Bash and POSIX shell scripts.</summary>
/// <remarks>
...
/// </remarks>
[Obsolete("Regex highlighting is superseded by the TextMate engine. Use SyntaxHighlighters.For(\"bash\") instead.")]
public class BashSyntaxHighlighter : ISyntaxHighlighter
{
	private readonly ISyntaxHighlighter? _inner = TextMateHighlighting.For("bash");
