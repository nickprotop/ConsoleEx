...
/// <summary>Syntax highlighter for HTML.</summary>
/// <remarks>
...
/// </remarks>
[Obsolete("Regex highlighting is superseded by the TextMate engine. Use SyntaxHighlighters.For(\"html\") instead.")]
public class HtmlSyntaxHighlighter : ISyntaxHighlighter
{
	private readonly ISyntaxHighlighter? _inner = TextMateHighlighting.For("html");
