...
/// <summary>Syntax highlighter for Razor.</summary>
/// <remarks>
...
/// </remarks>
[Obsolete("Regex highlighting is superseded by the TextMate engine. Use SyntaxHighlighters.For(\"razor\") instead.")]
public class RazorSyntaxHighlighter : ISyntaxHighlighter
{
	private readonly ISyntaxHighlighter? _inner = TextMateHighlighting.For("razor");
